...
Happy to inspect other quant variants, or dump full tensor names/shapes via `--tree`, if that helps land this or [PR #3838](https://github.com/huggingface/candle/pull/3838); no download needed either way.
