...
(`hf-fm inspect` reads safetensors headers over HTTP Range — the checks above fetched ~193 KiB, no weight data. `cargo install hf-fetch-model --features cli`.)
